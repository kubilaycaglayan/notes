...
birthday = Time.new(1991, 0o4, 15, 1, 12, 59)
puts birthday
...
# MORE FORMATTING
def give_me_date(n)
  month_names = %w[Ocak Şubat Mart Nisan Mayıs Haziran Temmuz Ağustos Eylül Ekim Kasım Aralık]
  day_names = %w[Pazartesi Salı Çarşamba Perşembe Cuma Cumartesi Pazar]
  month_names_short = %w[Ock Şbt Mrt Nis May Haz Tem Ağs Eyl Ekm Ksm Arl]
  day_names_short = %w[Pts Sal Çrş Per Cum Cts Paz]
